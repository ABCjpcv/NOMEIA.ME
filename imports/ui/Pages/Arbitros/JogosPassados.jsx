...
export function JogosPassados({ user }) {
  const colunasJogosPassados = [
    {
      title: "Jogo",
      dataIndex: "Jogo",
      key: "Jogo",
  ...
  function loadData() {
    ...
    Meteor.call("carregaResultadosJogosPassados", email, (err, result) => {
          ...
          <div className="demo-app-main" style={{ width: "100%" }}>
            <div className="container" style={{ width: "100%" }}>
              ...
              {dataSource.length != 0 ? (
                ...
                <h2 className="blue">Não tem jogos passados.</h2>
              )}
            </div>
          </div>
        </div>
