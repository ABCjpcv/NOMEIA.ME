  ...
  return (
    ...
    <Menu {...props}>
      <a className="menu-item">
            <p onClick={() => {document.getElementById("indisponibilidades").hidden=true;
                            document.getElementById("consultaPrivada").hidden=false;
                            document.getElementById("restricoes").hidden=true}}>
                                Consultar Nomeações </p>
        
      </a>

      <a className="menu-item" >
            <p onClick={() => {document.getElementById("indisponibilidades").hidden=false;
                            document.getElementById("consultaPrivada").hidden=true;
                            document.getElementById("restricoes").hidden=true}}>
                                Marcar Indisponibilidades</p>
